...
int main(int argc, char *argv[])
{
	...
	// Print header
	printf("TheKernel Versioning Utility\n"
           "...\n\n");
...
SkipParse:
	...
	// Print out header
	printf("generating kernel revision file...\n");
	fprintf(out, "/* Automatically generated revision file, do not change contents.\n");
	fprintf(out, " * Provides a time, date and description of the current kernel build. */\n");
	fprintf(out, "#ifndef _KERNEL_REVISION_H_\n");
	fprintf(out, "#define _KERNEL_REVISION_H_\n\n");
	...
	// End
	fprintf(out, "#endif //!_KERNEL_REVISION_H_\n");
