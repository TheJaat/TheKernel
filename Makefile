...
$(BUILD_DIR)/%.o: %.cpp
	@echo "Compiling $<..."
	$(CXX) -c $< -o $@ $(CXX_FLAGS) $(INCLUDES) -I$(SHARED_INCLUDE) -I$(KERNEL_INCLUDE) -I$(KERNEL_LIBC) -I$(KERNEL_LIB) -I$(KERNEL_DRIVER)
# 	$(CXX) -c $< -o $@ $(CXX_FLAGS) $(INCLUDES) -I$(SHARED_INCLUDE) -I$(KERNEL_INCLUDE) -I$(KERNEL_LIBC) -I$(KERNEL_DRIVER)
